...
<a href="<?= $WEB_CONFIG['base_url'] ?>adminprofile.php?page=add" class="btn btn-primary mb-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= $WEB_CONFIG['base_url'] ?>adminprofile.php?page=update&id=<?= $data['id'] ?>" class="btn btn-success m-1">
...
function alertDelete(idn) {
    c = '<?= $WEB_CONFIG['base_url'] ?>adminprofile.php?page=delete&id='+idn;
    console.log(c);
    $('#deleteButtonModal').attr('href', c);
