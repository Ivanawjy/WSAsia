...
if(isset($_POST['save'])){
    if(!isset($_POST['fullname']) || !isset($_POST['username']) || !isset($_POST['role']) || !$_POST['email'] || !$_POST['password']){
        ...
        $query = "UPDATE user SET fullname='$nama', username='$username', role='$role', password='$password', email='$email' WHERE id=$id";
        if (mysqli_query($con, $query)) {
            echo "<div class=\"alert alert-success\" role=\"alert\">User has been updated</div>";
        }else{
